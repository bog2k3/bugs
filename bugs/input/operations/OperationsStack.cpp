...
OperationsStack::OperationsStack(Viewport* pViewport, IOperationSpatialLocator* locator, IWorldManager* wldManager, b2World* physics)
	: m_context(new OperationContext(pViewport, this, locator, wldManager, physics))
	, m_stack()
{
}
